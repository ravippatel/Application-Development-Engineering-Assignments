 ...
 * @author Dell
 */
public class ViewCheckings extends javax.swing.JPanel {

    /**
     * Creates new form ViewCheckings
     */
    Checking check;
    public ViewCheckings(Checking check) {
        this.check=check;
        initComponents();
        displayChecking();
    }
    ...
    private void displayChecking() {
        ...
        TxtAcc.setText(check.getAccnumber());
        TxtAccbalance.setText(check.getAccbalance());
        TxtBname.setText(check.getName());
        TxtRouting.setText(check.getRoutingnumber());
        TxtType.setText(check.getAcctype());
    }
}
