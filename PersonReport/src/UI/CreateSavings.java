 ...
 * @author Dell
 */
public class CreateSavings extends javax.swing.JPanel {

    /**
     * Creates new form CreateSavings
     */
    Savings save;
    public CreateSavings(Savings save) {
        this.save=save;  
        initComponents();
    }
    ...
    private void BtnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCreateActionPerformed
        // TODO add your handling code here:
        save.setName(TxtBname.getText());
        save.setAccbalance(TxtAccbalance.getText());
        save.setAccnumber(TxtAcc.getText());
        save.setRoutingnumber(TxtRouting.getText());
        save.setAcctype(TxtType.getText());
